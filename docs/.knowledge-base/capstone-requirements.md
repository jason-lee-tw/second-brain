...
The "Second Brain" capstone assignment: build a multi-agent personal knowledge system using evaluation-driven development, with mandatory RAG, memory, OTEL tracing, and a fixed local tech stack.
...
## Data Sourcing and Model Choice

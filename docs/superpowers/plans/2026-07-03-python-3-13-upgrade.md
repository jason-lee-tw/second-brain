...
- [ ] **Step 1: Edit `apps/backend/pyproject.toml`**
...
- [ ] **Step 2: Edit `apps/eval/pyproject.toml`**
...
- [ ] **Step 4: Edit `docker/Dockerfile.backend`**
...
- [ ] **Step 5: Edit `docs/codebase/001-tech-stack.md`**
...
- [ ] **Step 9: Regenerate the lockfile — HARD GATE**
...
- [ ] **Step 10: Rebuild the local venv on 3.13**
...
- [ ] **Step 11: Verify the venv interpreter version**
...
- [ ] **Step 2: Run format and confirm no diff**
...
- [ ] **Step 1: Build the backend image on the new base**
...
- [ ] **Step 2: Verify the container's Python version**

Run: `docker compose exec backend python --version`
Expected: `Python 3.13.x`

- [ ] **Step 3: Exercise the real query path**
